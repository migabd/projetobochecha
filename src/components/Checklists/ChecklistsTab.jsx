    ...
    if (checklistState.view === 'edit') {
        ...
        return (
            <div className="max-w-3xl mx-auto p-6 space-y-6 animate-in fade-in pb-20">
                ...
                <div className={`bg-white dark:bg-zinc-900 p-8 rounded-3xl shadow-xl border-t-8 border-x border-b border-zinc-200 dark:border-zinc-800 ${selectedTheme.border.replace('border-', 'border-t-')}`}>
                    <div className="mb-8">
                        <label className="block text-xs font-black text-zinc-400 uppercase tracking-widest mb-2">Tema de Cores</label>
                    ...
                    <div className="space-y-6 mb-10">
                        <div>
                            <label className="block text-xs font-black text-zinc-400 uppercase tracking-widest mb-2">Título do Protocolo / Checklist</label>
                        ...
                        <div>
                            <label className="block text-xs font-black text-zinc-400 uppercase tracking-widest mb-2">Descrição Curta (Opcional)</label>
                        ...
                        {c.items.map((item, i) => (
                            <div key={item.id} className={`p-4 rounded-2xl border transition-all bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 group relative`}>
                                <div className="flex items-start gap-4">
                                    <div className={`mt-1 w-6 h-6 rounded-full border-2 border-zinc-300 dark:border-zinc-700 flex items-center justify-center text-xs font-black text-zinc-400`}>{i + 1}</div>
