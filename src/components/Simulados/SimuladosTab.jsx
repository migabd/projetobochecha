...
const SimuladosTab = ({ db, setDb, showAlert, callIA, aiConfig, directSimulado, setDirectSimulado }) => {
    ...
    useEffect(() => {
        if (directSimulado) {
            ...
            setTimerActive(true);
            setView('sim');
            setDirectSimulado(null); // Clear it so it doesn't trigger again
        }
    }, [directSimulado]);
        ...
        return (
            <div className="p-10 max-w-6xl mx-auto space-y-12 animate-in fade-in duration-700">
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div>
                        <h2 className="text-6xl font-black italic tracking-tighter neon-emerald uppercase">Simulados <span className="text-white/20">DE ELITE</span></h2>
